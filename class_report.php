 ...
 <body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple"><a href="class_report.php"><span class="fa fa-area-chart"></span>Class Report</a></li>
          ...
          <!-- start: content -->
            <div id="content">
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated slideInDown"><span class="fa fa-area-chart"></span>Class Report</h3>
                    </div>
                  </div>                    
                </div>
                <div class="col-md-12">
                    ...
                    <div class="col-md-2 padding-0">
                          ...
                          <select id="section_select" name="sec" onchange="fetch_ajax('section','subject',this.value);">
                            <option value="empty" selected></option>
                          </select>
                    </div> 
                   <div class="col-md-4 padding-0">
                          <lable><b>Subject:</b></lable>
                          <select id="subject_select" name="sub">
                            <option value="empty" selected></option>
                          </select>
                    </div>
                </div>
                ...
                <div class="mymodal">      
                    <canvas class="pie-chart" width="300px" height="300px">
                    </canvas>
                </div>
     ...
     <script>
         $(document).ready(function(){
                     ...
                     {
                        if (event.target == document.getElementsByClassName('mymodal')[0]) 
                        {
            ...
            $('#mybtn').click(function(){
                ...
                else if($('#subject_select').val()=="empty")
                    ...
                    else
                    {
                        $.ajax({
                            ...
                            success:function(response)
                            {
                                ...
                                $('#datatabl').DataTable();
                                $('#tb_head').html("<h3>"+$('#subject_select').val()+"</h3>");
                            } 
                        });
                    }
                }
                ...
                {
                    $('#tb_head').html($('#subject_select').val());
                    $.ajax({
				        type:'POST',
                        url:'table_class_report.php',
                        data:
         ...
         function fetch_ajax(iam,need,myval)
         {
             ...
             else if(iam=="section")
             {
		         ...
		         $.ajax({
				    ...
				    success:function(response)
                    {
                         $('#subject_select').html("<option value='empty'></option>"+response);
                    } 
             });
             }
		 }
         function chartgen(pre,abs,od)
         {
             var tot=pre+abs+od;
             if(tot>0)
             {
                var prep=(pre/tot)*100;
                 prep=Math.round(prep);
                var absp=(abs/tot)*100;
                 absp=Math.round(absp);
                var odp=(od/tot)*100;
                 odp=Math.round(odp);
             }
             var chartdata = [
