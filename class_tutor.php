      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start: content -->
            <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"><h3>Class Tutors</h3></div>
                        <div class="panel-body">
                            <div class="responsive-table">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                            <?php
                                $stm=$pdo->prepare("select * from ".$regix_id."_class_tutor");
                                $stm->execute();
                                while($row=$stm->fetch())
                                {
                                    echo "<tr>";
                                    ...
                                    echo "<td>".$row['regix_staff_id']."</td>";
																	  $stmt5=$pdo->prepare("select name from ".$regix_id."_staff_list where username=?");
																	  $stmt5->execute([$row['regix_staff_id']]);
																	  $name_of_staff=$stmt5->fetchColumn();
																		echo "<td>".$name_of_staff."</td>";
																	  echo "</tr>";
                                }
                            ?>  
                                    </tbody>
