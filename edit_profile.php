...
<head>
	...
	<meta name="author" content="aadhil" >
    ...
    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/0.8.1/cropper.min.css"/>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li class="active ripple"><a href="edit_profile.php"><span class="fa fa-user"></span>Profile</a></li>   
            ...
            <div id="content">
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-12">
                        <h3 class="animated fadeInLeft"><span class="fa fa-user"></span>Edit Profile</h3>
                    </div>
                  </div>
                </div>
                <div class="col-md-12">
                    <div class="col-md-4">
                        <div class="panel">
                            <div class="panel-heading"></div>
                                <div class="panel-body">
                                    <img src="asset/img/bg1.jpg" id="image"/>
                                </div>
                        </div>
                    </div>
                </div>    
