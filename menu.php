      ...
      <div class="container-fluid mimin-wrapper">
          ...
          <!-- start: content -->
            <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"><h3><?php echo "Department : ".$dep." && year : ".$year." && Section : ".$section;?></h3></div>
                        <div class="panel-body">
                            <div class='col-md-12'>
                                <?php echo "<a href='schedule.php?dep=".$dep."&year=".$year."&section=".$section."'>"; ?>
                                    <div class='outer col-md-4'>
                                        <div class='animated fadeInLeft hvr-sweep-to-right col-md-12 divelement'>  
                                              <span><b>Schedule</b></span>
                                        </div>
                                </div></a>
                               <?php echo "<a href='student.php?dep=".$dep."&year=".$year."&section=".$section."'>"; ?>
                                    <div class='outer col-md-4'>
                                        <div class='animated fadeInLeft hvr-sweep-to-right col-md-12 divelement'>  
