...
<head>
 ...
 <body id="mimin" class="dashboard">
      ...
      <div class="container-fluid mimin-wrapper">
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                   ...
                   <li class="active ripple"><a href="class_tutor.php"><span class="fa fa-book"></span>Class Tutor</a></li>
          ...
          <!-- start: content -->
            <div id="content">
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading"><h3 style="display:inline-block">Edit Class Tutor List</h3>
    ...
    <script src="asset/js/plugins/handsontable.full.min.js"></script>
	 											   <?php
                                $stm=$pdo->prepare("select department,year,section,regix_staff_id from ".$regix_id."_class_tutor");
                                $stm->execute();
																$i=0;
	 															if($stm->rowCount()==0)
																{
                                ...
                                {
																	  $data_array[$i]=[];
																	  $data_array[$i][0]=$row['department'];
																	  $data_array[$i][1]=$row['year'];
																	  $data_array[$i][2]=$row['section'];
																	  $data_array[$i][3]=$row['regix_staff_id'];
																	  $i++;
                                }	
																}
                            ?>
    <script type="text/javascript">
        $(document).ready(function () {					
					...
					var hot = new Handsontable(container, {
						data: fill_data(),
						rowHeaders: true,
						colHeaders: ['Department','year','section','username'],
						contextMenu: ['row_above', 'row_below', 'remove_row'],
						stretchH: 'all'
					}); 
					$('#savechanges').click(function(){
						var mydat=hot.getData();	
						$.post('save_edit_class_tutor.php',{mydat:mydat},function(response){
							window.location.href="edit_class_tutor.php";
						});
					});
				});
     </script>
